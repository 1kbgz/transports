<a href="https://github.com/1kbgz/transports">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://github.com/1kbgz/transports/raw/main/docs/img/logo-dark.webp?raw=true">
    <img alt="transports logo, concentric circles with a line connecting them with points" src="https://github.com/1kbgz/transports/raw/main/docs/img/logo-light.webp?raw=true" width="600">
  </picture>
</a>
...
`transports` moves typed models across any wire as incremental patches.

A model is defined once as a [pydantic](https://docs.pydantic.dev) model, stdlib `dataclass`, or
[msgspec](https://jcristharif.com/msgspec/) struct. A Python process hosts it and mutates it
normally, and transports sends only the patch needed to update a remote mirror. The same Rust core
drives Python (PyO3) and JavaScript (wasm), so both sides share the same `Value` type, diff, patch
application, and codecs.
